          ...
          {advantages.map((a, i) => {
            ...
            return (
              <Reveal key={a.titulo} delay={i * 0.06}>
                <div className="group h-full rounded-3xl border border-ink-100 bg-white p-7 transition-all hover:-translate-y-1 hover:border-brand-200 hover:shadow-xl">
                  ...
                  <p className="mt-2 text-ink-600">{a.descricao}</p>
                </div>
              </Reveal>
            )
          })}
